...
public class XxlJobLogDaoTest {
    ...
    @Test
    public void test() {
        List<XxlJobLog> list = xxlJobLogDao.pageList(0, 10, 1, 1, null, null, 1, 0);
        int list_count = xxlJobLogDao.pageListCount(0, 10, 1, 1, null, null, 1, 0);
        ...
        List<Long> ret4 = xxlJobLogDao.findClearLogIds(1, 1, new Date(), 100, 100, 0);
